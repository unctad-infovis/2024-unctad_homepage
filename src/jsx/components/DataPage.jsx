        ...
        <div className="overlay">
          <button className="anchor" onClick={() => openLink('https://unitednations.sharepoint.com/sites/UNCTAD_Intranet/SitePages/brand.aspx')} type="button">
            <div className="content">
              <h2>Brand book</h2>
              <p>
                What defines our brand and visual identity?
                <br />
                This section will guide you through our visual identity system and show you how to apply it consistently.
              </p>
                  ...
                  <button className="anchor" onClick={() => openLink('https://unitednations.sharepoint.com/sites/UNCTAD_Intranet/SitePages/brand.aspx')} type="button">
                    <div className="downloads_container white">
                      <div className="download_container">
                        ...
                        <h3>Font</h3>
                        <h4>Inter</h4>
                        <div className="locked button">Download</div>
                      </div>
                    </div>
                  </button>
                </div>
